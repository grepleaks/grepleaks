...
## Prerequisites
- Nikto available (Perl-based; install on demand: `command -v nikto || git clone https://github.com/suls/nikto.git /opt/nikto && ln -s /opt/nikto/nikto.pl /usr/local/bin/nikto`)
