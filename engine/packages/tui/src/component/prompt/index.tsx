...
import { createTypewriter, PENTEST_PROMPTS } from "../../prompt/typewriter"
...
export function Prompt(props: PromptProps) {
  ...
  const autoShortcut = useCommandShortcut("permission.mode")
  ...
  const list = createMemo(() => props.placeholders?.normal ?? PENTEST_PROMPTS)
  ...
  const animatedPlaceholder = createTypewriter(
    list,
    () =>
      animationsEnabled() &&
      store.mode === "normal" &&
                  ...
                  {(agent) => (
                    <>
                      ...
                      <Show when={store.mode === "normal" && local.permission.mode === "auto"}>
                        <text fg={theme.primary}>AUTO</text>
                      </Show>
            ...
            <box gap={2} flexDirection="row">
              ...
              <Switch>
                <Match when={store.mode === "normal"}>
                  ...
                  <text fg={local.permission.mode === "auto" ? theme.primary : theme.text}>
                    {autoShortcut()}{" "}
                    <span style={{ fg: theme.textMuted }}>
                      {local.permission.mode === "auto" ? "to disable Auto mode" : "to enable Auto mode"}
                    </span>
                  </text>
                  <text fg={theme.text}>
