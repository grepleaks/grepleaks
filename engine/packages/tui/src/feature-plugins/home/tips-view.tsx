...
const NO_MODELS_TIP = "Run {highlight}/models{/highlight} to connect Grepleaks or add your own model"
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/models{/highlight} to manage your saved model connections",
