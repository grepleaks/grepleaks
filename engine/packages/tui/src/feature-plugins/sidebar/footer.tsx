...
function View(props: { api: TuiPluginApi; sessionID: string }) {
  ...
  return (
    <box gap={1}>
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>Choose a model to start your engagement.</text>
            <text fg={theme().textMuted}>
              Configure your model provider with /connect.
            </text>
      ...
      <text fg={theme().textMuted}>
        <span style={{ fg: theme().primary }}>•</span> <b>grep</b>
