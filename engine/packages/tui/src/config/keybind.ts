...
export const Definitions = {
  ...
  model_list: keybind("none", "List available models"),
  model_cycle_recent: keybind("none", "Next recently used model"),
  model_cycle_recent_reverse: keybind("none", "Previous recently used model"),
  ...
  permission_mode: keybind("tab", "Toggle Auto mode"),
